...
export const realisations: Realisation[] = [
  ...
  },
  {
    ...
    context: "Le service de sécurité effectuait jusque-là ses rondes et consignait les incidents sur papier, sans preuve de passage horodatée ni vue consolidée en temps réel.",
    ...
    solution: "Une application digitalisant la sécurité et la maintenance du site : chaque salle et équipement possède un QR code unique généré automatiquement, imprimable individuellement ou par bâtiment. Les agents de sécurité effectuent leurs rondes numériques avec preuve horodatée de passage à chaque point de contrôle, y compris hors connexion — la synchronisation se fait au retour du réseau. Un incident se déclare en un scan : type et constat prédéfinis pour les agents (ex. « Sûreté » → « Vitre brisée »), formulaire libre pour les autres profils. Une main courante consolide en temps réel l'ensemble des incidents déclarés, consultable par les responsables qui pilotent bâtiments, zones, espaces et équipes depuis un tableau de bord centralisé, avec export des rapports de ronde ou d'intervention en PDF.",
    features: [
    ...
    results: "Une preuve horodatée et vérifiable de chaque ronde de sécurité, une main courante centralisée et consultable en temps réel, et un signalement d'incident en un scan de QR code à la place d'une transmission papier ou orale.",
    technologies: [],
    isPlaceholder: false,
  },
];
