...
export const realisations: Realisation[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Traçabilité de chaque demande, du dépôt à la clôture",
      "Coordination documentaire avec le service comptabilité (devis, factures, entretiens)",
      "Conformité RGPD, en remplacement du fichier Excel enregistré dans le réseau local et des documents dispersés en comptabilité",
    ],
    ai: [
