            ...
            <div className="bg-surface rounded-2xl p-8 border border-slate-200 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-slate-900 font-medium mb-2">🔒 Stockage technique essentiel</h3>
                  ...
                  <div>
                    <h3 className="text-slate-900 font-medium mb-2">📊 Google Analytics (mesure d&apos;audience)</h3>
                    <p className="text-slate-600 text-sm">
              ...
              <section>
                ...
                <div className="mt-4 text-slate-600">
                  ...
                  <p><strong className="text-slate-900">Adresse :</strong> 7 rue Vivienne, 75002 Paris, France</p>
                </div>
                <p className="text-slate-600 mt-4">
